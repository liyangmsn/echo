...
import { PusherConnector, SocketIoConnector, WeappConnector } from './connector';
...
class Echo {
    ...
    constructor(options: any) {
        ...
        } else if (this.options.broadcaster == 'weapp') {
            this.connector = new WeappConnector(this.options);
        }
    }
